...
public class Road2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        bottomRoad.transform.localScale = new Vector3(1f, 1f, 30f);
        bottomRoad.transform.Rotate(0f, 0f, 0f, Space.Self);

        GameObject pentaRoad = new GameObject();
        pentaRoad.name = "Penta Road";
        pentaRoad.transform.position = new Vector3(
           this.transform.position.x +30f,
           this.transform.position.y,
           this.transform.position.z);
        pentaRoad.transform.parent = this.transform;
        CreateRoadSegment(pentaRoad);
        pentaRoad.transform.localScale = new Vector3(1f, 1f, 30f);
        bottomRoad.transform.Rotate(0f, -50f, 0f, Space.Self);
